...
pub use config::{
    ...
    MISSING_INT, NAME, NAME as CF_NAME, NODE_DTYPE, OINTERF, OINTERT, OMAP, ORG, OSLOTS, OTEXT,
    OTYPE, OVOLUME, OWORK, PORT_BASE, PROTOCOL, RANK_DTYPE, RELATIVE, REPO, SEARCH_FAIL_FACTOR,
    TRY_LIMIT_FROM, TRY_LIMIT_TO, TYPE_DTYPE, URL_CF_DOCS, URL_GH, URL_GH_API, URL_GH_UPLOAD,
    URL_GL, URL_GL_API, URL_GL_UPLOAD, URL_NB, VERSION, VERSION as CF_VERSION, WARP, YARN_RATIO,
};
pub use corpus::{
