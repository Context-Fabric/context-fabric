#!/usr/bin/env python3
"""Generate golden-master outputs from Text-Fabric oracle probes."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default=os.environ.get("CONTEXT_FABRIC_GOLDEN_OUTPUT_DIR"))
