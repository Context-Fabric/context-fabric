...
\end{{figure}}"""
    ...
    text = text.replace(
        ...
        "The re-write of TF → CF was done by Opus 4.5, based on my prompting and specifications. "
...
def style_document(input_docx: Path) -> None:
    ...
    acknowledgements_started = False
    acknowledgement_paragraphs = []
    ...
    for index, paragraph in enumerate(document.paragraphs):
        ...
        if index == 0:
            ...
            acknowledgements_started = value == "Acknowledgements"
        ...
        if acknowledgements_started and value != "Acknowledgements":
            acknowledgement_paragraphs.append(paragraph)

    for paragraph in acknowledgement_paragraphs:
        paragraph.paragraph_format.keep_together = True
    for paragraph in acknowledgement_paragraphs[:-1]:
        paragraph.paragraph_format.keep_with_next = True
